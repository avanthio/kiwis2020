...
okapi::Motor  rightConveyorMotor(6,false, okapi::AbstractMotor::gearset::blue, okapi::AbstractMotor::encoderUnits::degrees);
okapi::Motor leftConveyorMotor(7,true,okapi::AbstractMotor::gearset::blue, okapi::AbstractMotor::encoderUnits::degrees);
...
okapi::MotorGroup Conveyor({leftConveyorMotor,rightConveyorMotor});
